<div class="main-card mb-3 card">
	...
	<div class="card-body">
		<form enctype="multipart/form-data" class="" method="POST" action="<?php echo base_url('cabang_simpan'); ?>">
			<div class="row">
				...
				<div class="col-sm-8">
					<div class="position-relative row form-group">
						...
						<div class="col-sm-4">
							<input required name="cabang_nama" placeholder="Input cabang" type="text" class="form-control">
						</div>
					</div>
					<div class="position-relative row form-group">
						<label for="exampleEmail" class="col-sm-2 col-form-label">Deskripsi</label>
						<div class="col-sm-4">
							<textarea name="cabang_deskripsi" class="form-control" cols="30" rows="6" placeholder="Input deskripsi cabang"></textarea>
						</div>
					</div>
