<div class="main-card mb-3 card">
	...
	<div class="card-body">
		<form enctype="multipart/form-data" class="" method="POST" action="<?php echo base_url('step_simpan'); ?>">
			<div class="row">
				...
				<div class="col-sm-8">
					<div class="position-relative row form-group">
						...
						<div class="col-sm-4">
							<input required name="step_kode" placeholder="Input kode" type="text" class="form-control">
						</div>
					</div>
					<div class="position-relative row form-group">
						<label for="exampleEmail" class="col-sm-2 col-form-label">Step</label>
						<div class="col-sm-4">
							<input required name="step_nama" placeholder="Input step" type="text" class="form-control">
						</div>
					</div>
					<div class="position-relative row form-group">
						<label for="exampleEmail" class="col-sm-2 col-form-label">Order</label>
						<div class="col-sm-4">
							<input required name="step_order" placeholder="Input order" type="number" class="form-control">
						</div>
					</div>
					<div class="position-relative row form-group">
						<label for="exampleEmail" class="col-sm-2 col-form-label">Deskripsi</label>
						<div class="col-sm-4">
							<textarea name="step_deskripsi" class="form-control" cols="30" rows="6" placeholder="Input deskripsi bantuan"></textarea>
						</div>
					</div>
